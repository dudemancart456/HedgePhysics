...
public class Action00_Regular : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Do Spindash
        if (Input.GetButton("B") && Player.Grounded)
        {
        ...
        //Play Rolling Sound
        if (Input.GetButtonDown("R1") && Player.Grounded)
        {
        ...
        //Do a homing attack
        if (!Player.Grounded && Input.GetButtonDown("A") && Actions.Action02Control.HasTarget &&
